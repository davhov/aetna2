...
- `k8s/onboarding-portal.yaml`: in-cluster DFKI-branded web portal, reachable for `daho03` from the admin-only `OnBoarding` button inside `Code Server Links`.
